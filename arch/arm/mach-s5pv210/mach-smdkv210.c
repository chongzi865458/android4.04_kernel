...
#define MANGO210_UCON_DEFAULT	(S3C2410_UCON_TXILEVEL |	\
...
#define MANGO210_ULCON_DEFAULT	S3C2410_LCON_CS8

#define MANGO210_UFCON_DEFAULT	(S3C2410_UFCON_FIFOMODE |	\
...
static struct s3c2410_uartcfg mango210_uartcfgs[] __initdata = {
	[0] = {
		.hwport		= 0,
		.flags		= 0,
		.ucon		= MANGO210_UCON_DEFAULT,
		.ulcon		= MANGO210_ULCON_DEFAULT,
		.ufcon		= MANGO210_UFCON_DEFAULT,
	},
#if 1
	[1] = {
		.hwport		= 1,
...
/* LDO */
static struct regulator_consumer_supply mango210_ldo3_consumer[] = {
	REGULATOR_SUPPLY("pd_io", "s3c-usbgadget"),
	REGULATOR_SUPPLY("pd_io", "s5p-ohci"),
	REGULATOR_SUPPLY("pd_io", "s5p-ehci"),
};

static struct regulator_consumer_supply mango210_ldo5_consumer[] = {
	REGULATOR_SUPPLY("AVDD", "0-001b"),
	REGULATOR_SUPPLY("DVDD", "0-001b"),
};

static struct regulator_consumer_supply mango210_ldo8_consumer[] = {
	REGULATOR_SUPPLY("pd_core", "s3c-usbgadget"),
	REGULATOR_SUPPLY("pd_core", "s5p-ohci"),
	REGULATOR_SUPPLY("pd_core", "s5p-ehci"),
};

static struct regulator_init_data mango210_ldo2_data = {
	.constraints	= {
		.name		= "VALIVE_1.1V",
		.min_uV		= 1100000,
		.max_uV		= 1100000,
...
static struct regulator_init_data mango210_ldo3_data = {
	.constraints	= {
	...
	.num_consumer_supplies	= ARRAY_SIZE(mango210_ldo3_consumer),
	.consumer_supplies	= mango210_ldo3_consumer,
};

static struct regulator_init_data mango210_ldo4_data = {
	.constraints	= {
		.name		= "V_MIPI_1.8V",
		.min_uV		= 1800000,
		.max_uV		= 1800000,
...
static struct regulator_init_data mango210_ldo5_data = {
	.constraints	= {
		.name		= "VMMC+VEXT_2.8V",
		.min_uV		= 2800000,
		.max_uV		= 2800000,
	...
	.num_consumer_supplies	= ARRAY_SIZE(mango210_ldo5_consumer),
	.consumer_supplies	= mango210_ldo5_consumer,
};

static struct regulator_init_data mango210_ldo6_data = {
	.constraints	= {
		.name		= "VCC_2.6V",
		.min_uV		= 2600000,
		.max_uV		= 2600000,
...
static struct regulator_init_data mango210_ldo7_data = {
	.constraints	= {
		.name		= "VDAC_2.8V",
		.min_uV		= 2800000,
		.max_uV		= 2800000,
...
static struct regulator_init_data mango210_ldo8_data = {
	.constraints	= {
	...
	.num_consumer_supplies	= ARRAY_SIZE(mango210_ldo8_consumer),
	.consumer_supplies	= mango210_ldo8_consumer,
};

static struct regulator_init_data mango210_ldo9_data = {
	.constraints	= {
...
/* BUCK */
static struct regulator_consumer_supply mango210_buck1_consumer =
	REGULATOR_SUPPLY("vddarm", NULL);

static struct regulator_consumer_supply mango210_buck2_consumer =
	REGULATOR_SUPPLY("vddint", NULL);

static struct regulator_init_data mango210_buck1_data = {
	.constraints	= {
		.name		= "VCC_ARM",
		.min_uV		= 750000,
		.max_uV		= 1500000,
	...
	.consumer_supplies	= &mango210_buck1_consumer,
};

static struct regulator_init_data mango210_buck2_data = {
	.constraints	= {
		.name		= "VCC_INTERNAL",
		.min_uV		= 950000,
		.max_uV		= 1200000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &mango210_buck2_consumer,
};

static struct regulator_init_data mango210_buck3_data = {
	.constraints	= {
		.name		= "VCC_MEM",
		.min_uV		= 1800000,
		.max_uV		= 1800000,
...
static struct max8698_regulator_data mango210_regulators[] = {
	{ MAX8698_LDO2,  &mango210_ldo2_data },
	{ MAX8698_LDO3,  &mango210_ldo3_data },
	{ MAX8698_LDO4,  &mango210_ldo4_data },
	{ MAX8698_LDO5,  &mango210_ldo5_data },
	{ MAX8698_LDO6,  &mango210_ldo6_data },
	{ MAX8698_LDO7,  &mango210_ldo7_data },
	{ MAX8698_LDO8,  &mango210_ldo8_data },
	{ MAX8698_LDO9,  &mango210_ldo9_data },
	{ MAX8698_BUCK1, &mango210_buck1_data },
	{ MAX8698_BUCK2, &mango210_buck2_data },
	{ MAX8698_BUCK3, &mango210_buck3_data },
};

static struct max8698_platform_data mango210_max8698_pdata = {
	.num_regulators = ARRAY_SIZE(mango210_regulators),
	.regulators     = mango210_regulators,
...
static struct regulator_init_data mango210_b_pwr_5v_data = {
        .constraints = {
                .always_on = 1,
        },
        .num_consumer_supplies  = ARRAY_SIZE(mango210_b_pwr_5v_consumers),
        .consumer_supplies      = mango210_b_pwr_5v_consumers,
};

static struct fixed_voltage_config mango210_b_pwr_5v_pdata = {
        .supply_name    = "B_PWR_5V",
        .microvolts     = 5000000,
        .init_data      = &mango210_b_pwr_5v_data,
	.gpio		= -1,
};

static struct platform_device mango210_b_pwr_5v = {
        .name          = "reg-fixed-voltage",
        .id            = -1,
        .dev = {
                .platform_data = &mango210_b_pwr_5v_pdata,
        },
};
#endif
...
static void mango210_backlight_exit(struct device *dev)
{
	s3c_gpio_cfgpin(S5PV210_GPD0(0), S3C_GPIO_OUTPUT);
	gpio_free(S5PV210_GPD0(0));
}

static struct platform_pwm_backlight_data mango210_backlight_data = {
	.pwm_id		= 3,
	.max_brightness	= 255,
	.dft_brightness	= 255,
	.lth_brightness = 50,
	.pwm_period_ns	= 25000,
	.init		= mango210_backlight_init,
	.exit		= mango210_backlight_exit,
};

static struct platform_device mango210_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.parent		= &s3c_device_timer[3].dev,
		.platform_data	= &mango210_backlight_data,
	},
};
...
static struct gpio_keys_platform_data mango210_buttons_data  = {
        .buttons        = mango210_buttons,
        .nbuttons       = ARRAY_SIZE(mango210_buttons),
};

static struct platform_device mango210_buttons_device  = {
        .name           = "gpio-keys",
        .id             = 0,
        .num_resources  = 0,
        .dev            = {
                .platform_data  = &mango210_buttons_data,
        }
};
...
static void mango210_board_cfg_gpio(void)
{
        u32 i, gpio;
...
#else
static int mango210_cam1_power(int onoff)
{
	int err;
...
static int s5k5ba_power_en(int onoff)
{
	if (onoff) {
#ifdef CAM_ITU_CH_A
		mango210_cam0_power(onoff);
#else
		mango210_cam1_power(onoff);
#endif
	} else {
#ifdef CAM_ITU_CH_A
		mango210_cam0_power(onoff);
...
static int mango210_mipi_cam_pwr_en(int enabled)
{
	int err;
...
static int mango210_mipi_cam_rstn(int enabled)
{
	int err;
...
static int mango210_mipi_cam_power(int on)
{
	if (on) {
		mango210_mipi_cam_pwr_en(1);
		mdelay(5);
		mango210_mipi_cam_rstn(1);
	} else {
		mango210_mipi_cam_rstn(0);
		mdelay(5);
		mango210_mipi_cam_pwr_en(0);
	}
	return 0;
}
#endif
...
static struct s3c_platform_camera s5k4ea = {
	...
	.initialized	= 0,
	.cam_power	= mango210_mipi_cam_power,
};
#endif
...
static struct i2c_board_info mango210_i2c_devs1[] __initdata = {
#ifdef CONFIG_VIDEO_TV20
        {
...
static struct i2c_board_info mango210_i2c_devs2[] __initdata = {
#if defined(CONFIG_REGULATOR_MAX8698)
        {
                I2C_BOARD_INFO("max8698", 0xCC >> 1),
                .platform_data  = &mango210_max8698_pdata,
        },
#endif
};
...
/* USB EHCI */
static struct s5p_ehci_platdata mango210_ehci_pdata;
static void __init mango210_ehci_init(void)
{
        struct s5p_ehci_platdata *pdata = &mango210_ehci_pdata;

        s5p_ehci_set_platdata(pdata);
}

/*USB OHCI*/
static struct s5p_ohci_platdata mango210_ohci_pdata;
static void __init mango210_ohci_init(void)
{
        struct s5p_ohci_platdata *pdata = &mango210_ohci_pdata;

        s5p_ohci_set_platdata(pdata);
}

/*USB DEVICE*/
static struct s5p_otg_platdata mango210_otg_pdata;
static void __init mango210_otg_init(void)
{
        struct s5p_otg_platdata *pdata = &mango210_otg_pdata;

        s5p_otg_set_platdata(pdata);
}

#define BACKLIGHT_GPIO  S5PV210_GPD0(0)
#define LCD_EN_GPIO     S5PV210_GPC1(4)

static int lg_lb070wv6_lcd_on(void)
{
    int err;

    /* OnOff LCD_5.0V */
    err = gpio_request(BACKLIGHT_GPIO, "BACKLIGHT");
    err = gpio_request(LCD_EN_GPIO, "LCD_EN");
    ...
    s3c_gpio_setpull(LCD_EN_GPIO, S3C_GPIO_PULL_UP);
...
//	s3c24xx_ts_set_platdata(&s3c_ts_platform);
	...
	i2c_register_board_info(0, mango210_i2c_devs0,
			ARRAY_SIZE(mango210_i2c_devs0));
	i2c_register_board_info(1, mango210_i2c_devs1,
			ARRAY_SIZE(mango210_i2c_devs1));
	i2c_register_board_info(2, mango210_i2c_devs2,
		 	ARRAY_SIZE(mango210_i2c_devs2));
#ifdef CONFIG_TOUCHSCREEN_EGALAX
...
static void __init mango210_fixup(struct machine_desc *mdesc, struct tag *tags, char **cmdline,
                struct meminfo *mi)
{
