...
#ifndef CONFIG_SND_SAMSUNG_I2S
	/*
	 * Return if I2S is not enabled as this is the only wake-up
	 * Source from Deep Idle mode.
	 */
	return 1;
#endif
