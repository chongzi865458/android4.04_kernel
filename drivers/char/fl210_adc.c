...
#ifdef CONFIG_TOUCHSCREEN_FL6410
extern int fl6410_adc_acquire_io(void);
extern void fl6410_adc_release_io(void);
#else
static inline int fl6410_adc_acquire_io(void) {
	return 0;
}
static inline void fl6410_adc_release_io(void) {
	/* Nothing */
}
#endif
